...
public class AuthServerOAuth2Config extends AuthorizationServerConfigurerAdapter {
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		...
		LOG.info("AuthServerOAuth2Config... ClientDetailsServiceConfigurer>>>");
		clients.inMemory()
	...
	public void configure(AuthorizationServerEndpointsConfigurer endpoints) throws Exception {
		LOG.info("AuthServerOAuth2Config... AuthorizationServerEndpointsConfigurer>>>");
	...
	public void configure(AuthorizationServerSecurityConfigurer oauthServer) throws Exception {
		LOG.info("AuthServerOAuth2Config...AuthorizationServerSecurityConfigurer>>>");
